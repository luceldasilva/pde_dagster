...
from data_engineering.process_transactions.pos import (
    transform_pos_transactions
)
from data_engineering.process_transactions.online import (
    transform_online_transactions
)
from data_engineering.process_transactions.crypto import (
    transform_crypto_transactions
)


@op(
    name="streamed_process_records_op",
